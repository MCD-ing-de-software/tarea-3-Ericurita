...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_drop_invalid_rows_removes_rows_with_missing_values(self):
        ...
        # No debe haber valores faltantes en name ni age
    ...
    def test_trim_strings_strips_whitespace_without_changing_other_columns(self):
        ...
        # En el resultado, los nombres ya no tienen espacios al inicio/final
        ...
        # También podemos verificar que el DataFrame original es igual a la copia
    ...
    def test_remove_outliers_iqr_removes_extreme_values(self):
        ...
        # Alguno de los valores normales (25 o 35) debe seguir presente
        ages = result["age"].tolist()
        self.assertTrue(any(val in ages for val in [25, 35]))
